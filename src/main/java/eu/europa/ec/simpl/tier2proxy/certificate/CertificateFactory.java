...
final class CertificateFactory {
	...
	CertificateFactory(X500Name caSubject,
	...
	private CertificateInfo createCertificate(CertificateInfo caCertificateInfo, String host)
		...
		X509v3CertificateBuilder certBuilder =
				new JcaX509v3CertificateBuilder(issuer, serial,
						certificateValidityPeriod.before(), certificateValidityPeriod.after(), subject,
						keyPair.getPublic());
	...
	private CertificateInfo createCACertificate() throws CertificateException, OperatorCreationException, IOException {
		...
		JcaX509v3CertificateBuilder certBuilder =
				new JcaX509v3CertificateBuilder(caSubject, serial,
						certificateValidityPeriod.before(), certificateValidityPeriod.after(), caSubject,
						keyPair.getPublic());
