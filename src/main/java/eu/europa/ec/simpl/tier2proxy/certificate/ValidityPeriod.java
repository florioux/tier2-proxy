...
final class ValidityPeriod {
	...
	@NonNull
	private final ChronoUnit beforeDateAmountToSubtractUnit, afterDateAmountToAddUnit;
	...
	CertificateValidityPeriod from() {
		...
		return new CertificateValidityPeriod(
				Date.from(beforeInstant), Date.from(afterInstant)
		);
	}
}
